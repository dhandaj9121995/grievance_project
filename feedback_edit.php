...
$query3=mysql_query("update tb_feedback set tc_feedback='$name' where tc_feedbackid='$id'");
if($query3)
{
$query1=mysql_query("select tc_feedback from tb_feedback");
}
}
$query1=mysql_query("select * from tb_feedback where tc_feedbackid='$id'");
$query2=mysql_fetch_array($query1);
?>
<div id="section">
<form method="post" action="">
Feedback-Name:<input type="text" name="name" value="<?php echo $query2['tc_feedback']; ?>" /><br />
