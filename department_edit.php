...
$query3=mysql_query("update tb_department set tc_dept_name='$name' where id='$id'");
if($query3)
{
$query1=mysql_query("select tc_dept_name from tb_department");
}
}
$query1=mysql_query("select * from tb_department where id='$id'");
$query2=mysql_fetch_array($query1);
?>
<div id="section">
<form method="post" action="">
Department-Name:<input type="text" name="name" value="<?php echo $query2['tc_dept_name']; ?>" /><br />
